...
SECRET_KEY = 'django-insecure-$udti$47yvk5dmey!8!s-8u-yc+ivifvh3*09%23wionaklggr'
...
AUTH_USER_MODEL = 'courses_app.CustomUser'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'courses_db',  # Название базы данных
        'USER': 'root',  # Имя пользователя MySQL
        'PASSWORD': 'Lopo1',  # Пароль
